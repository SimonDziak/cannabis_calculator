...
class FormulaResults extends StatefulWidget {

  Formula formula;

  FormulaResults({Key key, @required this.formula}) : super(key: key);

  @override
  _FormulaResultsState createState() => _FormulaResultsState();
}

class _FormulaResultsState extends State<FormulaResults> {
